declare module ValjangEngine {
    ...
    class Engine {
         ...
         * @param {ValjangEngine.Viewport} viewport - the viewport element to be used.
        ...
        /**
         * Usually called from ValjangEngine.Texture.ts.  Passed information to create a WebGLTexture.
         ...
         *
         * @returns {WebGLTexture} for assignment back into ValjangEngine.Texture
         */
...
interface WebGLTexture {
    ...
    _sphericalPolynomial: ValjangEngine.SphericalPolynomial;
    _lodTextureHigh: ValjangEngine.BaseTexture;
    _lodTextureMid: ValjangEngine.BaseTexture;
    _lodTextureLow: ValjangEngine.BaseTexture;
}
...
declare module ValjangEngine {
    ...
    class Node {
        ...
        */
         ...
         * @param {ValjangEngine.Scene} the scene this node will be added to
         */
         ...
         * @param {ValjangEngine.Node} ancestor - The parent node to inspect
         * @see parent
         */
         ...
         * @param {ValjangEngine.Node[]} results the result array containing the nodes matching the given criterias
         ...
         * @param {boolean} directDescendantsOnly if true only direct descendants of 'this' will be considered, if false direct and also indirect (children of children, an so on in a recursive manner) descendants of 'this' will be considered.
         * @param predicate: an optional predicate that will be called on every evaluated children, the predicate must return true for a given child to be part of the result, otherwise it will be ignored.
         * @return {ValjangEngine.Node[]} all children nodes of all types.
         */
...
declare module ValjangEngine {
    ...
    /**
     * This type contains all the data related to a pointer event in ValjangEngine.js.
    ...
    class Scene implements IAnimatable {
        ...
        * @see ValjangEngine.Light
        * @type {ValjangEngine.Light[]}
        */
        lights: Light[];
        /**
        * All of the cameras added to this scene.
        * @see ValjangEngine.Camera
        * @type {ValjangEngine.Camera[]}
        */
        cameras: Camera[];
        ...
        * @see ValjangEngine.AbstractMesh
        * @type {ValjangEngine.AbstractMesh[]}
        */
        meshes: AbstractMesh[];
        private _geometries;
        materials: Material[];
         ...
         * @type {ValjangEngine.ActionManager}
        */
        ...
        /**
         * @constructor
         * @param {ValjangEngine.Engine} engine - the engine to be used to render this scene.
         */
         ...
         * @return {ValjangEngine.AbstractMesh} mesh under the pointer/mouse cursor or null if none.
         */
        ...
        */
         ...
         * @return {ValjangEngine.Camera|null} the new active camera or null if none found.
         * @see activeCamera
         */
         ...
         * @return {ValjangEngine.Material|null} the material or null if none found.
         */
         ...
         * @return {ValjangEngine.Camera|null} the camera or null if none found.
         */
        getCameraByName(name: string): Camera;
        /**
         * get a bone using its id
         * @param {string} the bone's id
         * @return {ValjangEngine.Bone|null} the bone or null if not found
         */
        ...
        */
         ...
         * @return {ValjangEngine.Light|null} the light or null if none found.
         */
         ...
         * @return {ValjangEngine.ParticleSystem|null} the corresponding system or null if none found.
         */
        getParticleSystemByID(id: string): ParticleSystem;
        /**
         * get a geometry using its ID
         * @param {string} the geometry's id
         * @return {ValjangEngine.Geometry|null} the geometry or null if none found.
         */
        getGeometryByID(id: string): Geometry;
        /**
         * add a new geometry to this scene.
         * @param {ValjangEngine.Geometry} geometry - the geometry to be added to the scene.
         ...
         * @param {ValjangEngine.Geometry} geometry - the geometry to be removed from the scene.
         ...
         * @return {ValjangEngine.AbstractMesh|null} the mesh found or null if not found at all.
         */
         ...
         * @param {string} id - the id to search for
         * @return {ValjangEngine.Node|null} the node found or null if not found at all.
         */
         ...
         * @param {ValjangEngine.Vector3} [gravity] - the scene's gravity for the physics engine
         * @param {ValjangEngine.IPhysicsEnginePlugin} [plugin] - The physics engine to be used. defaults to OimoJS.
...
declare module ValjangEngine {
    ...
    class ActionManager {
        ...
        **/
         ...
         * @param {ValjangEngine.Action} action - the action to be registered
         * @return {ValjangEngine.Action} the action amended (prepared) after registration
         */
        registerAction(action: Action): Action;
        /**
         * Process a specific trigger
         * @param {number} trigger - the trigger to process
         * @param evt {ValjangEngine.ActionEvent} the event details to be processed
         */
...
declare module ValjangEngine {
    class BoneLookController {
        ...
        upAxis: Vector3;
        /**
         * The space that the up axis is in - ValjangEngine.Space.BONE, ValjangEngine.Space.LOCAL (default), or ValjangEngine.Space.WORLD.
         */
        upAxisSpace: Space;
        /**
         ...
         * - upAxisSpace: the space that the up axis is in - ValjangEngine.Space.BONE, ValjangEngine.Space.LOCAL (default), or ValjangEngine.Space.WORLD.
...
declare module ValjangEngine {
    ...
    interface ICameraInput<TCamera extends ValjangEngine.Camera> {
        camera: TCamera;
        getTypeName(): string;
    ...
    interface CameraInputsMap<TCamera extends ValjangEngine.Camera> {
        [name: string]: ICameraInput<TCamera>;
        [idx: number]: ICameraInput<TCamera>;
    }
    class CameraInputsManager<TCamera extends ValjangEngine.Camera> {
...
declare module ValjangEngine {
    ...
    interface ValjangEngineMessage {
...
declare module ValjangEngine {
    ...
    abstract class ShadowLight extends Light implements IShadowLight {
         ...
         * Returns the light.
         */
        setShadowProjectionMatrix(matrix: 0, viewMatrix: 0, renderList: Array<AbstractMesh>): IShadowLight;
    }
}
...
declare module ValjangEngine {
    class EffectFallbacks {
        ...
        addCPUSkinningFallback(rank: number, mesh: ValjangEngine.AbstractMesh): void;
...
declare module ValjangEngine {
    ...
    class ImageProcessingConfiguration {
         ...
         */
        vignetteColor: ValjangEngine.Color4;
        /**
...
declare module ValjangEngine {
    ...
    class SceneLoader {
        ...
        * @param engine is the instance of ValjangEngine.Engine to use to create the scene
        */
        ...
        * @param rootUrl a string that defines the root url for scene and resources
        * @param sceneFilename a string that defines the name of the scene file. can start with "data:" following by the stringified version of the scene
        * @param scene is the instance of ValjangEngine.Scene to append to
        */
...
declare module ValjangEngine {
    class AbstractMesh extends Node implements IDisposable, ICullable, IGetSetVerticesData {
        ...
        */
        actionManager: ActionManager;
        physicsImpostor: ValjangEngine.PhysicsImpostor;
         ...
         * - ValjangEngine.VertexBuffer.PositionKind
         * - ValjangEngine.VertexBuffer.UVKind
         * - ValjangEngine.VertexBuffer.UV2Kind
         * - ValjangEngine.VertexBuffer.UV3Kind
         * - ValjangEngine.VertexBuffer.UV4Kind
         * - ValjangEngine.VertexBuffer.UV5Kind
         * - ValjangEngine.VertexBuffer.UV6Kind
         * - ValjangEngine.VertexBuffer.ColorKind
         * - ValjangEngine.VertexBuffer.MatricesIndicesKind
         * - ValjangEngine.VertexBuffer.MatricesIndicesExtraKind
         * - ValjangEngine.VertexBuffer.MatricesWeightsKind
         * - ValjangEngine.VertexBuffer.MatricesWeightsExtraKind
         *
         * Returns the Mesh.
         */
        ...
        */
         ...
         * space (default LOCAL) can be either ValjangEngine.Space.LOCAL, either ValjangEngine.Space.WORLD.
...
declare module ValjangEngine {
    ...
    class Mesh extends AbstractMesh implements IGetSetVerticesData {
        ...
        */
        ...
        private _source;
        readonly source: ValjangEngine.Mesh;
        /**
         * @constructor
         ...
         * You can set the mesh side orientation with the values : ValjangEngine.Mesh.FRONTSIDE (default), ValjangEngine.Mesh.BACKSIDE or ValjangEngine.Mesh.DOUBLESIDE
         * The mesh can be set to updatable with the boolean parameter `updatable` (default false) if its internal geometry is supposed to change once created.
...
declare module ValjangEngine.Internals {
    class MeshLODLevel {
        distance: number;
        mesh: Mesh;
...
declare module ValjangEngine {
     ...
     * Ported mostly from QSlim and http://voxels.blogspot.de/2014/05/quadric-mesh-simplification-with-source.html to ValjangEngine JS
     * @author RaananW
     */
...
declare module ValjangEngine {
    ...
    class PhysicsImpostor {
         ...
         */
        onCollideEvent: (collider: ValjangEngine.PhysicsImpostor, collidedWith: ValjangEngine.PhysicsImpostor) => void;
        onCollide: (e: {
            body: any;
        }) => void;
        /**
...
declare module ValjangEngine {
    class VolumetricLightScatteringPostProcess extends PostProcess {
        ...
        */
         ...
         * @param {ValjangEngine.Camera} camera - The camera that the post-process will be attached to
         * @param {ValjangEngine.Mesh} mesh - The mesh used to create the light scattering
         * @param {number} samples - The post-process quality, default 100
         * @param {number} samplingMode - The post-process filtering mode
         * @param {ValjangEngine.Engine} engine - The ValjangEngine engine
         * @param {boolean} reusable - If the post-process is reusable
         * @param {ValjangEngine.Scene} scene - The constructor needs a scene reference to initialize internal components. If "camera" is null (RenderPipelineà, "scene" must be provided
         */
         ...
         * @param {ValjangEngine.Vector3} The new custom light position
         */
        setCustomMeshPosition(position: Vector3): void;
        /**
         * Returns the light position for light scattering effect
         * @return {ValjangEngine.Vector3} The custom light position
         */
         ...
         * @return {ValjangEngine.RenderTargetTexture} The render target texture used by the post-process
         */
        ...
        * @param {ValjangEngine.Scene} The scene where to create the mesh
        * @return {ValjangEngine.Mesh} the default mesh
        */
...
declare module ValjangEngine {
    class TextureTools {
         ...
         */
        static CreateResizedCopy(texture: ValjangEngine.Texture, width: number, height: number, useBilinearMode?: boolean): ValjangEngine.Texture;
...
declare module ValjangEngine {
    ...
    class ColorGradingTexture extends BaseTexture {
        ...
        delayLoad(): void;
        /**
         * Parses a color grading texture serialized by ValjangEngine.
...
declare module ValjangEngine {
    ...
    class HDRCubeTexture extends BaseTexture {
        ...
        private _isValjangEnginePreprocessed;
        private _onLoad;
        private _onError;
        /**
         * The texture URL.
        ...
        /**
         * Occurs when the file is a preprocessed .ValjangEngine.hdr file.
         */
        private loadValjangEngineTexture();
        /**
         ...
         */
        static generateValjangEngineHDROnDisk(url: string, size: number, onError?: (() => void)): void;
        /**
         ...
         * @return The packed binary data.
         */
        static generateValjangEngineHDR(url: string, size: number, callback: ((ArrayBuffer: ArrayBuffer) => void), onError?: (() => void)): void;
    }
}
...
declare module ValjangEngine {
    class VideoTexture extends Texture {
         ...
         * Sample : https://doc.ValjangEnginejs.com/tutorials/01._Advanced_Texturing
         * @param {Array} urlsOrVideo can be used to provide an array of urls or an already setup HTML video element.
         * @param {ValjangEngine.Scene} scene is obviously the current scene.
...
declare module ValjangEngine {
    class DefaultRenderingPipeline extends PostProcessRenderPipeline implements IDisposable, IAnimatable {
        ...
        pass: ValjangEngine.PassPostProcess;
        highlights: ValjangEngine.HighlightsPostProcess;
        blurX: ValjangEngine.BlurPostProcess;
        blurY: ValjangEngine.BlurPostProcess;
        copyBack: ValjangEngine.PassPostProcess;
        fxaa: FxaaPostProcess;
        imageProcessing: ImageProcessingPostProcess;
        finalMerge: ValjangEngine.PassPostProcess;
        animations: Animation[];
         ...
         * @param {ValjangEngine.Scene} scene - The scene linked to this pipeline
         * @param {any} ratio - The size of the postprocesses (0.5 means that your postprocess will have a width = canvas.width 0.5 and a height = canvas.height 0.5)
         * @param {ValjangEngine.Camera[]} cameras - The array of cameras that the rendering pipeline will be attached to
         */
...
declare module ValjangEngine {
    class LensRenderingPipeline extends PostProcessRenderPipeline {
        ...
        */
         ...
         *      grain_texture: ValjangEngine.Texture;     // texture to use for grain effect; if unset, use random B&W noise
...
declare module ValjangEngine {
    class StandardRenderingPipeline extends PostProcessRenderPipeline implements IDisposable, IAnimatable {
        ...
        */
         ...
         * @param {ValjangEngine.Scene} scene - The scene linked to this pipeline
         * @param {any} ratio - The size of the postprocesses (0.5 means that your postprocess will have a width = canvas.width 0.5 and a height = canvas.height 0.5)
         * @param {ValjangEngine.PostProcess} originalPostProcess - the custom original color post-process. Must be "reusable". Can be null.
         * @param {ValjangEngine.Camera[]} cameras - The array of cameras that the rendering pipeline will be attached to
         */
