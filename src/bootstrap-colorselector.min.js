...
! function(t) {
    "use strict";
    var o = function(o, e) { this.options = e, this.$select = t(o), this._init() };
    o.prototype = {
        constructor: o,
        _init: function() {
        ...
        _clickColor: function(o) { var e = t(o.target); return e.is(".color-btn") ? (this.$select.val(e.data("value")).change(), o.preventDefault(), !0) : !1 },
        setColor: function(o) {
            var e = t(this.$selector).find("li").find("a[data-color='" + o + "']").data("value");
            this.setValue(e)
        },
        setValue: function(t) { this.$select.val(t).change() }
    ...
    }, t.fn.colorselector.defaults = { callback: function() {}, colorsPerRow: 8 }, t.fn.colorselector.Constructor = o
