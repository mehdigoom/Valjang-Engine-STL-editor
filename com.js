...
function addmodel(){
    ...
    Link = "<input type='text' id='Link' class='fadeIn third' name='login' placeholder='Link' value ='"+Serveruplaud+"/model/'>"
    ...
    image= "<input type='text' id='image' class='fadeIn third' name='login' placeholder='image' value ='"+Serveruplaud+"/img/'>"
